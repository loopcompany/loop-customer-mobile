...
## مشکل:
تاریخ آپلود قرارداد به صورت میلادی نمایش داده می‌شد بجای تاریخ شمسی.
...
- **تاریخ بارگذاری قرارداد ادمین**: ۱۴۰۳/۰۸/۲۱
- **تاریخ آپلود قرارداد کاربر**: ۱۴۰۳/۰۸/۲۱  
- **تاریخ بررسی قرارداد**: ۱۴۰۳/۰۸/۲۲
