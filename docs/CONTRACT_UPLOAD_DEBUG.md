# مراحل Debug برای مشکل آپلود توافق نامه

## مشکل گزارش شده:
**توافق نامهم چرا اپلود نمیشه؟**
...
- آیا دکمه "آپلود توافق نامه" فعال می‌شود؟

### 2. بررسی فرآیند آپلود:
- وقتی دکمه "آپلود توافق نامه" را می‌زنید، آیا loading spinner نمایش داده می‌شود؟
...
### مرحله 2: بررسی آپلود
1. روی دکمه "آپلود توافق نامه" کلیک کنید
2. Console logs را بررسی کنید:
