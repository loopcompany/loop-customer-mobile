...
// ---------------------------------------------------------------------------
// نکته: توضیحات مهم ۲ فقط «نام شرکت + شماره ثبت» را خواسته، ولی در همه‌ی
// تصاویر طرح «شناسه ملی» چاپ شده است. چون هر دو شناسه‌ی قانونی معتبرند و
// حذف هرکدام یکی از دو منبع را نقض می‌کند، هر دو نگه داشته شده‌اند. اگر
// کارفرما فقط یکی را خواست، همین‌جا یک خط حذف می‌شود.
export const ISSUER = {
  companyName: 'حلقه بی نهایت رایانه ایرانیان',
  registrationNumber: '044915',
  nationalId: '14011307124',
