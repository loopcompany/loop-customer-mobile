...
export const SYSTEMATIC_FLOWS = {
  ...
  laptop: [
    ...
    },
    {
      id: 'model',
      title: 'مدل لپ تاپ',
      hint: 'مدل دقیق، شماره سریال و مشخصات کلی دستگاه را وارد کنید تا تکنسین با قطعه‌ی مناسب مراجعه کند.',
      icon: deviceIcon.laptop,
      type: 'fields',
      fields: [
        { id: 'model', placeholder: 'مدل لپ تاپ' },
    ...
    },
    {
      ...
      hint: 'ایرادهای سخت‌افزاری متداول لپ تاپ؛ هر مورد که مصداق دارد را انتخاب کنید.',
      icon: sectionIcon.hardware,
      type: 'checklist',
      options: [
        { id: 'no_power', title: 'لپ تاپ روشن نمی‌شود' },
        { id: 'slow', title: 'لپ تاپ کند است' },
        { id: 'no_display', title: 'صفحه نمایش تصویر ندارد' },
        { id: 'keyboard', title: 'کیبورد کار نمی‌کند' },
        { id: 'touchpad', title: 'تاچ‌پد کار نمی‌کند' },
        { id: 'battery', title: 'باتری / آداپتور شارژ نمی‌کند' },
        { id: 'ports', title: 'پورت‌ها کار نمی‌کنند' },
        { id: 'overheat', title: 'داغ می‌شود / فن صدا دارد' },
